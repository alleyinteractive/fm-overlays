...
class Fm_Overlays_Admin extends Fm_Overlays_Singleton {
	...
	public function admin_assets() {
		...
		if ( Fm_Overlays_Post_Type()->get_post_type() === get_post_type() ) {
			wp_enqueue_script( 'fm-overlays-admin-js', FM_OVERLAYS_ASSET_URL . '/static/js/admin.min.js', array(), FM_OVERLAYS_ASSETS_VERSION, true );
			wp_enqueue_style( 'fm-overlays-admin-css', FM_OVERLAYS_ASSET_URL . '/static/css/admin.min.css', array(), FM_OVERLAYS_ASSETS_VERSION );
		}
	}
}
