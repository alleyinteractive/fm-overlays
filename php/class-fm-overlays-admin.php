...
class Fm_Overlays_Admin extends Fm_Overlays_Singleton {
	...
	public function admin_assets() {
		...
		if ( 'fm-overlay' === get_post_type() ) {
			wp_enqueue_script( 'fm-overlays-admin-js', FM_OVERLAYS_ASSET_DIR . '/static/js/fm-overlays-admin.js', array( 'jquery' ), FM_GLOBAL_ASSET_VERSION, true );
			wp_enqueue_style( 'fm-overlays-admin-css', FM_OVERLAYS_ASSET_DIR . '/static/css/fm-overlays-admin.css', array(), FM_GLOBAL_ASSET_VERSION );
		}
	}
}
